...
all_node_results = {
    ...
    "SOUSA-GIRAFFE": (load_node_data("data/sousa/Results_line_ratio_sousa.fits", 1), None, "GIRAFFE"),
    "SOUSA-UVES": (load_node_data("data/sousa/Results_line_ratio_sousa.fits", 1), None, "UVES"),
    "BOLOGNA": (load_node_data("data/bologna/Bologna_GES_CoRoTv2/GES_CoRoT_25May2014_Bologna_NEW.fits", 1), None, "UVES"),
